      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <span className="text-xs font-semibold bg-slate-100 text-slate-500 px-3 py-1.5 rounded-lg border border-slate-200">
              Read-Only Schedule
            </span>
          </div>
        </div>
              ...
              >
                ...
                <div className="flex justify-end gap-2 border-t border-slate-100 pt-3">
                  ...
                  {app.type === 'Virtual' && app.status !== 'Completed' && app.status !== 'Cancelled' && (
                    <button
                      disabled
                      className="px-3.5 py-1.5 bg-slate-100 border border-slate-200 text-slate-400 rounded-lg text-xs font-medium cursor-not-allowed flex items-center gap-1.5"
                      title="Virtual consultations are restricted to Doctor accounts."
                    >
                      <Video className="h-3.5 w-3.5" />
                      Join Call (Doctor Only)
                    </button>
                  )}
                </div>
              </div>
