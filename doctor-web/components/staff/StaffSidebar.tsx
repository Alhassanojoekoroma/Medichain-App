...
const navItems = [
  ...
  { href: '/staff/inventory', icon: Pill, label: 'Drug Inventory' },
  { href: '/staff/dispensing', icon: Clock, label: 'Dispensing Log' },
...
export default function StaffSidebar({ isOpen, onToggle }: SidebarProps) {
    ...
    <>
      ...
      >
        <div className="p-5 flex items-center gap-2">
          <div className="w-10 h-10 bg-[#FA6E3C] rounded-full flex items-center justify-center">
            <span className="text-white font-bold text-lg">M</span>
          </div>
          <div className="flex flex-col">
            <div className="flex items-center gap-1">
              <span className="font-semibold text-base text-[#101326]">MediChain</span>
              <span className="bg-[#FA6E3C] text-white text-[10px] font-medium px-1.5 py-0.2 rounded-full">SL</span>
            </div>
            <span className="text-[10px] text-[#FA6E3C] font-semibold -mt-1">Staff / Pharmacy</span>
          </div>
        ...
        <div className="px-5 pb-4 border-b border-[#D8DCE8]">
          <div className="flex items-center gap-2 text-xs text-[#8C91A8] mb-2">
            <span>MediChain</span>
            <span>&gt;</span>
            <span className="text-[#101326] font-medium">Staff</span>
          </div>
              ...
              return (
                <a
                  ...
                  className={cn(
                    ...
                    isActive ? 'text-[#FA6E3C] bg-[#FFF7ED] border-[#FA6E3C]' : 'text-[#5D6582] hover:bg-slate-50 border-transparent'
                  )}
