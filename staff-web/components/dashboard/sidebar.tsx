...
import {
  ...
  Bell, Settings, LogOut, ChevronUp, ChevronDown,
...
const mainNavItems = [
  ...
  { href: '/appointments', icon: Calendar, label: 'Queue / Check-in' },
  { href: '/prescriptions', icon: ClipboardList, label: 'Prescriptions' },
  { href: '/inventory', icon: Package, label: 'Inventory' },
  { href: '/dispensing', icon: FileText, label: 'Dispensed Logs' },
...
export function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  const displayName = currentUser?.name || 'James Cole';
        ...
        <div className="p-5 flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1">
              ...
              <span className="bg-[#d97706] text-white text-[10px] font-medium px-1.5 py-0.2 rounded-full">SL</span>
            </div>
            <span className="text-[10px] text-[#d97706] font-semibold -mt-1">Pharmacy Portal</span>
          </div>
                ...
                return (
                  <a
                    ...
                    className={cn(
                      ...
                      isActive ? 'text-[#d97706] bg-[#fef3c7] border-[#d97706]' : 'text-[#5D6582] hover:bg-slate-50 border-transparent'
                    )}
