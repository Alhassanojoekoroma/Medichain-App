      ...
      >
        <div className="p-5 flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-[#7c3aed] font-semibold -mt-1">Admin Portal</span>
          </div>
                ...
                return (
                  <a
                    ...
                    className={cn(
                      ...
                      isActive ? 'text-[#7c3aed] bg-[#f5f3ff] border-[#7c3aed]' : 'text-[#5D6582] hover:bg-slate-50 border-transparent'
                    )}
