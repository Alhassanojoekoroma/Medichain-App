      ...
      >
        <div className="p-5 flex items-center gap-2">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1">
              ...
              <span className="bg-[#0284c7] text-white text-[10px] font-medium px-1.5 py-0.2 rounded-full">SL</span>
            </div>
            <span className="text-[10px] text-[#0284c7] font-semibold -mt-1">Ministry of Health</span>
          </div>
        ...
        <div className="px-5 pb-4 border-b border-[#D8DCE8]">
          <div className="flex items-center gap-2 text-xs text-[#8C91A8] mb-2">
            <span>MediChain</span>
            <span>&gt;</span>
            <span className="text-[#101326] font-medium">Government</span>
          </div>
                ...
                return (
                  <a
                    ...
                    className={cn(
                      ...
                      isActive ? 'text-[#0284c7] bg-[#e0f2fe] border-[#0284c7]' : 'text-[#5D6582] hover:bg-slate-50 border-transparent'
                    )}
